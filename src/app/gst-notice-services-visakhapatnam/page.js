...
import {
  ...
  heroDataNoticeServicesVisakhapatnam,
} from "@/utils/data";
...
export const metadata = {
  title:
    "GST Notice Reply Services in Visakhapatnam | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-visakhapatnam",
  },
};

const GstNoticeServicesVisakhapatnam = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Visakhapatnam | Expert GST notice
          handling. Strong legal replies. Penalty reduction.
        </title>
        ...
        <meta
          name="keywords"
          content="GST notice services Visakhapatnam, GST notice reply Visakhapatnam, GST audit notice reply Visakhapatnam, DRC-01 reply Visakhapatnam, GST legal reply Visakhapatnam, GST show cause notice reply Visakhapatnam"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-visakhapatnam"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Visakhapatnam | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Visakhapatnam. Expert handling of DRC-01, DRC-02, SCN, audit notices & more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-visakhapatnam"
        />
        <meta property="og:type" content="website" />

        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-visakhapatnam-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Visakhapatnam | Fast & Accurate Legal Reply - UNIgst"
        />

        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment, and representation. Reduce penalties with strong legal responses in Visakhapatnam."
        />

        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-visakhapatnam-twitter.jpg"
        />
      ...
      {/* HERO SECTION */}
      <CompanySection data={heroDataNoticeServicesVisakhapatnam} />

      {/* KEEP EXACTLY SAME – DO NOT CHANGE */}
...
export default GstNoticeServicesVisakhapatnam;
