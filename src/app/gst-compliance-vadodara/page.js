...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceVadodara, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Vadodara | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Vadodara. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Vadodara, GST audit support, GST notice management, complete GST services, GST compliance management Vadodara",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-vadodara",
  },
  openGraph: {
    title: "GST Compliance Services in Vadodara | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Vadodara. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-vadodara",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-vadodara-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Vadodara",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Vadodara | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-vadodara-twitter.jpg"],
  },
};

const GstComplianceVadodara = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceVadodara} />
...
export default GstComplianceVadodara;
