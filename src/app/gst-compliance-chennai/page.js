...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceChennai, heroDataComplianceDelhi, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Chennai | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Chennai. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Chennai, GST audit support, GST notice management, complete GST services, GST compliance management Chennai",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-chennai",
  },
  openGraph: {
    title: "GST Compliance Services in Chennai | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Chennai. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-chennai",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-chennai-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Chennai",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Chennai | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-chennai-twitter.jpg"],
  },
};

const GstComplianceChennai = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceChennai} />
...
export default GstComplianceChennai;
