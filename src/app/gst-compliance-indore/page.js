...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceIndore, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Indore | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Indore. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Indore, GST audit support, GST notice management, complete GST services, GST compliance management Indore",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-indore",
  },
  openGraph: {
    title: "GST Compliance Services in Indore | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Indore. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-indore",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-indore-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Indore",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Indore | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-indore-twitter.jpg"],
  },
};

const GstComplianceIndore = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceIndore} />
...
export default GstComplianceIndore;
