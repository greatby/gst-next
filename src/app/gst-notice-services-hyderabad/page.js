...
import {
  ...
  heroDataNoticeServicesHyderabad,
} from "@/utils/data";
...
export const metadata = {
  title:
    "GST Notice Reply Services in Hyderabad | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-hyderabad",
  },
};

const GstNoticeServicesHyderabad = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Hyderabad | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Hyderabad, GST notice reply Hyderabad, GST audit notice reply, DRC-01 reply Hyderabad, GST legal reply Hyderabad, GST show cause notice reply Hyderabad"
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-hyderabad"
        />

        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Hyderabad | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Hyderabad. Expert handling of DRC-01, DRC-02, SCN, audit notices and more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-hyderabad"
        />
        <meta property="og:type" content="website" />

        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-hyderabad-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Hyderabad | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-hyderabad-twitter.jpg"
        />
      ...
      {/* Hyderabad Hero Data */}
      <CompanySection data={heroDataNoticeServicesHyderabad} />
...
export default GstNoticeServicesHyderabad;
