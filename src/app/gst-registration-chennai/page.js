...
export const metadata = {
  title: "GST Registration Services in Chennai | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Chennai in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Chennai, new GST registration, online GST registration, GST number Chennai, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-chennai",
  },
};

const GstRegistrationChennai = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Chennai",
    },
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: "https://www.unigst.com/gst-registration-chennai",
      },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationChennai} />
...
export default GstRegistrationChennai;
