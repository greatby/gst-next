...
export const metadata = {
  title: "GST Registration Services in Surat | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Surat in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Surat, new GST registration, online GST registration, GST number Surat, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-surat",
  },
};

const GstRegistrationSurat = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Surat",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Surat?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Registration Surat", item: "https://www.unigst.com/gst-registration-surat" },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationSurat} />
...
export default GstRegistrationSurat;
