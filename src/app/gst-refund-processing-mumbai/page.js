...
import {
  ...
  faqsRefundBangalore,
  heroDataRefundProcessingMumbai,
...
export const metadata = {
  title:
    "GST Refund Processing Services in Mumbai | Fast ITC & Export Refunds",
  description:
    "Fast GST refund processing in Mumbai. Export refunds in 30–45 days. ITC refunds handled with expert documentation for maximum refund recovery.",
  alternates: {
    canonical: "https://www.unigst.com/gst-refund-processing-mumbai",
  },
};

const GstRefundProcessingMumbai = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        ...
        <meta
          name="description"
          content="Fast GST refund processing in Mumbai. Export refunds processed in 30–45 days. Expert ITC refund claims with maximum recovery and error-free documentation."
        />

        <meta
          name="keywords"
          content="GST refund Mumbai, GST refund processing, ITC refund Mumbai, export refund Mumbai, GST RFD-01 filing, GST consultant Mumbai"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-refund-processing-mumbai"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Refund Processing Services in Mumbai | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-refund-processing-mumbai"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-refund-processing-mumbai-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Refund Processing in Mumbai | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-refund-processing-mumbai-twitter.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Fast GST refund claims for exporters and ITC applicants in Mumbai. Expert filing with maximum refund recovery.",
      ...
      {/* Hero + Sections */}
      <CompanySection data={heroDataRefundProcessingMumbai} />
...
export default GstRefundProcessingMumbai;
