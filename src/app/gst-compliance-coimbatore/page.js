...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceCoimbatore, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Coimbatore | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Coimbatore. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Coimbatore, GST audit support, GST notice management, complete GST services, GST compliance management Coimbatore",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-coimbatore",
  },
  openGraph: {
    title: "GST Compliance Services in Coimbatore | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Coimbatore. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-coimbatore",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-coimbatore-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Coimbatore",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Coimbatore | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-coimbatore-twitter.jpg"],
  },
};

const GstComplianceCoimbatore = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceCoimbatore} />
...
export default GstComplianceCoimbatore;
