...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceDelhi, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Delhi | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Delhi. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Delhi, GST audit support, GST notice management, complete GST services, GST compliance management Delhi",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-delhi",
  },
  openGraph: {
    title: "GST Compliance Services in Delhi | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Delhi. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-delhi",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-delhi-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Delhi",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Delhi | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-delhi-twitter.jpg"],
  },
};

const GstComplianceDelhi = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceDelhi} />
...
export default GstComplianceDelhi;
