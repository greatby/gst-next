...
export const metadata = {
  title: "GST Registration Services in Noida | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Noida in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Noida, new GST registration, online GST registration, GST number Noida, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-noida",
  },
};

const GstRegistrationNoida = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Noida",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Noida?",
        acceptedAnswer: {
          "@type": "Answer",
...
export default GstRegistrationNoida;
