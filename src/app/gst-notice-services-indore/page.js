...
export const metadata = {
  title:
    "GST Notice Reply Services in Indore | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-indore",
  },
};

const GstNoticeServicesIndore = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Indore | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Indore, GST notice reply Indore, GST audit notice reply Indore, DRC-01 reply Indore, GST legal reply Indore, GST show cause notice reply Indore"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-indore"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Indore | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Indore. Expert handling of DRC-01, DRC-02, SCN, audit notices & more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-indore"
        />
        <meta property="og:type" content="website" />

        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-indore-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Indore | Fast & Accurate Legal Reply - UNIgst"
        />

        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment, and representation. Reduce penalties with strong legal responses in Indore."
        />

        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-indore-twitter.jpg"
        />
      ...
      {/* HERO */}
      <CompanySection data={heroDataNoticeServicesIndore} />
...
export default GstNoticeServicesIndore;
