...
export const metadata = {
  title: "GST Registration Services in Indore | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Indore in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Indore, new GST registration, online GST registration, GST number Indore, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-indore",
  },
};

const GstRegistrationIndore = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Indore",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Indore?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Registration Indore", item: "https://www.unigst.com/gst-registration-indore" },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationIndore} />
...
export default GstRegistrationIndore;
