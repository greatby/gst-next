...
export const metadata = {
  title: "GST Registration Services in Pune | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Pune in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Pune, new GST registration, online GST registration, GST number Pune, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-pune",
  },
};

const GstRegistrationPune = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Pune",
    },
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Registration Pune", item: "https://www.unigst.com/gst-registration-pune" },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationPune} />
...
export default GstRegistrationPune;
