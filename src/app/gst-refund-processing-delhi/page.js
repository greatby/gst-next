...
export const metadata = {
  title:
    "GST Refund Processing Services in Delhi | Fast ITC & Export Refunds",
  description:
    "Fast GST refund processing in Delhi. Export refunds in 30–45 days. ITC refunds handled with expert documentation for maximum refund recovery.",
  alternates: {
    canonical: "https://www.unigst.com/gst-refund-processing-delhi",
  },
};

const GstRefundProcessingDelhi = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        ...
        <meta
          name="description"
          content="Fast GST refund processing in Delhi. Export refunds processed in 30–45 days. Expert ITC refund claims with maximum recovery and error-free documentation."
        />

        <meta
          name="keywords"
          content="GST refund Delhi, GST refund processing, ITC refund Delhi, export refund Delhi, GST RFD-01 filing, GST consultant Delhi"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-refund-processing-delhi"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Refund Processing Services in Delhi | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-refund-processing-delhi"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-refund-processing-delhi-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Refund Processing in Delhi | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-refund-processing-delhi-twitter.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Fast GST refund claims for exporters and ITC applicants in Delhi. Expert filing with maximum refund recovery.",
      ...
      {/* Hero + Sections */}
      <CompanySection data={heroDataRefundProcessingDelhi} />
...
export default GstRefundProcessingDelhi;
