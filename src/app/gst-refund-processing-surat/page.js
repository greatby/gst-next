...
export const metadata = {
  title:
    "GST Refund Processing Services in Surat | Fast ITC & Export Refunds",
  description:
    "Fast GST refund processing in Surat. Export refunds in 30–45 days. ITC refunds handled with expert documentation for maximum refund recovery.",
  alternates: {
    canonical: "https://www.unigst.com/gst-refund-processing-surat",
  },
};

const GstRefundProcessingSurat = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        ...
        <meta
          name="description"
          content="Fast GST refund processing in Surat. Export refunds processed in 30–45 days. Expert ITC refund claims with maximum recovery and error-free documentation."
        />

        <meta
          name="keywords"
          content="GST refund Surat, GST refund processing, ITC refund Surat, export refund Surat, GST RFD-01 filing, GST consultant Surat"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-refund-processing-surat"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Refund Processing Services in Surat | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-refund-processing-surat"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-refund-processing-surat-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Refund Processing in Surat | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-refund-processing-surat-twitter.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Fast GST refund claims for exporters and ITC applicants in Surat. Expert filing with maximum refund recovery.",
      ...
      {/* Hero + Sections */}
      <CompanySection data={heroDataRefundProcessingSurat} />
...
export default GstRefundProcessingSurat;
