...
export const metadata = {
  title: "GST Registration Services in Delhi | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Delhi in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Delhi, new GST registration, online GST registration, GST number Delhi, GSTIN registration services",
  alternates: {
...
const GstRegistrationDelhi = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Delhi",
    },
  };
...
export default GstRegistrationDelhi;
