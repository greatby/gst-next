...
export const metadata = {
  title:
    "GST Notice Reply Services in Lucknow | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-lucknow",
  },
};

const GstNoticeServicesLucknow = () => {
  return (
    <>
      <Head>
        {/* Title */}
        <title>
          GST Notice Reply Services in Lucknow | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Lucknow, GST notice reply Lucknow, GST audit notice reply Lucknow, DRC-01 reply Lucknow, GST legal reply Lucknow, GST show cause notice reply Lucknow"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-lucknow"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Lucknow | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Lucknow. Expert handling of DRC-01, DRC-02, SCN, audit notices & more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-lucknow"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-lucknow-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Lucknow | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment & representation. Reduce penalties with strong legal responses in Lucknow."
        />
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-lucknow-twitter.jpg"
        />
      ...
      {/* HERO */}
      <CompanySection data={heroDataNoticeServicesLucknow} />

      {/* SAME SECTIONS BELOW - DO NOT CHANGE */}
...
export default GstNoticeServicesLucknow;
