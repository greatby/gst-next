...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceLucknow, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Lucknow | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Lucknow. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Lucknow, GST audit support, GST notice management, complete GST services, GST compliance management Lucknow",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-lucknow",
  },
  openGraph: {
    title: "GST Compliance Services in Lucknow | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Lucknow. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-lucknow",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-lucknow-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Lucknow",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Lucknow | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-lucknow-twitter.jpg"],
  },
};

const GstComplianceLucknow = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceLucknow} />
...
export default GstComplianceLucknow;
