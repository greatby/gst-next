...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceKolkata, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Kolkata | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Kolkata. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Kolkata, GST audit support, GST notice management, complete GST services, GST compliance management Kolkata",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-kolkata",
  },
  openGraph: {
    title: "GST Compliance Services in Kolkata | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Kolkata. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-kolkata",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-kolkata-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Kolkata",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Kolkata | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-kolkata-twitter.jpg"],
  },
};

const GstComplianceKolkata = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceKolkata} />
...
export default GstComplianceKolkata;
