...
export const metadata = {
  title:
    "GST Notice Reply Services in Chennai | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-chennai",
  },
};

const GstNoticeServicesChennai = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Chennai | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Chennai, GST notice reply Chennai, GST audit notice reply, DRC-01 reply Chennai, GST legal reply Chennai, GST show cause notice reply Chennai"
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-chennai"
        />

        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Chennai | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Chennai. Expert handling of DRC-01, DRC-02, SCN, audit notices and more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-chennai"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-chennai-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Chennai | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-chennai-twitter.jpg"
        />
      ...
      {/* Chennai Hero Data */}
      <CompanySection data={heroDataNoticeServicesChennai} />
...
export default GstNoticeServicesChennai;
