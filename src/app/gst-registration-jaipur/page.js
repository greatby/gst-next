...
export const metadata = {
  title: "GST Registration Services in Jaipur | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Jaipur in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Jaipur, new GST registration, online GST registration, GST number Jaipur, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-jaipur",
  },
};

const GstRegistrationJaipur = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Jaipur",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Jaipur?",
        acceptedAnswer: {
          "@type": "Answer",
...
export default GstRegistrationJaipur;
