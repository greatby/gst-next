...
import { aboutSectionData, aboutSectionDataComplianceBangalore, faqsCompliance, heroData, heroDataComplianceBangalore, heroDataComplianceMumbai, processSteps, processStepsComplianceBangalore } from "@/utils/data";
...
export const metadata = {
  title: "GST Compliance Services in Mumbai | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Mumbai. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Mumbai, GST audit support, GST notice management, complete GST services, GST compliance management Mumbai",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-mumbai",
  },
  openGraph: {
    title: "GST Compliance Services in Mumbai | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Bangalore. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-mumbai",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-mumbai-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services mumbai",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Mumbai | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-mumbai-twitter.jpg"],
  },
};

const GstComplianceMumbai = () => {
  return (
    <>
    <Script
        id="service-schema"
      ...
      />
      <CompanySection data={heroDataComplianceMumbai} />
...
export default GstComplianceMumbai;
