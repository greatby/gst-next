...
import {
  ...
  heroDataNoticeServicesAhmedabad,
} from "@/utils/data";
...
export const metadata = {
  title:
    "GST Notice Reply Services in Ahmedabad | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-ahmedabad",
  },
};

const GstNoticeServicesAhmedabad = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Ahmedabad | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Ahmedabad, GST notice reply Ahmedabad, GST audit notice reply, DRC-01 reply Ahmedabad, GST legal reply Ahmedabad, GST show cause notice reply Ahmedabad"
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-ahmedabad"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Ahmedabad | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Ahmedabad. Expert handling of DRC-01, DRC-02, SCN, audit notices and more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-ahmedabad"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-ahmedabad-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Ahmedabad | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment, and representation. Reduce penalties with strong legal responses in Ahmedabad."
        />
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-ahmedabad-twitter.jpg"
        />
      ...
      {/* Ahmedabad Hero Section */}
      <CompanySection data={heroDataNoticeServicesAhmedabad} />
...
export default GstNoticeServicesAhmedabad;
