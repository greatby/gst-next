...
export const metadata = {
  title: "GST Registration Services in Vadodara | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Vadodara in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Vadodara, new GST registration, online GST registration, GST number Vadodara, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-vadodara",
  },
};

const GstRegistrationVadodara = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Vadodara",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Vadodara?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Registration Vadodara", item: "https://www.unigst.com/gst-registration-vadodara" },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationVadodara} />
...
export default GstRegistrationVadodara;
