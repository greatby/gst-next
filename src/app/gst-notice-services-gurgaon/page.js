...
export const metadata = {
  title:
    "GST Notice Reply Services in Gurgaon | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-gurgaon",
  },
};

const GstNoticeServicesGurgaon = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Gurgaon | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Gurgaon, GST notice reply Gurgaon, GST audit notice reply, DRC-01 reply Gurgaon, GST legal reply Gurgaon, GST show cause notice reply Gurgaon"
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-gurgaon"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Gurgaon | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Gurgaon. Expert handling of DRC-01, DRC-02, SCN, audit notices and more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-gurgaon"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-gurgaon-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Gurgaon | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment, and representation. Reduce penalties with strong legal responses in Gurgaon."
        />
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-gurgaon-twitter.jpg"
        />
      ...
      {/* Gurgaon Hero */}
      <CompanySection data={heroDataNoticeServicesGurgaon} />
...
export default GstNoticeServicesGurgaon;
