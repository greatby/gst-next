...
export const metadata = {
  title: "GST Registration Services in Kolkata | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Kolkata in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Kolkata, new GST registration, online GST registration, GST number Kolkata, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-kolkata",
  },
};

const GstRegistrationKolkata = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Kolkata",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Kolkata?",
        acceptedAnswer: {
          "@type": "Answer",
...
export default GstRegistrationKolkata;
