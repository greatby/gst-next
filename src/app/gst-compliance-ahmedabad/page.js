...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceAhmedabad, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Ahmedabad | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Ahmedabad. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Ahmedabad, GST audit support, GST notice management, complete GST services, GST compliance management Ahmedabad",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-ahmedabad",
  },
  openGraph: {
    title: "GST Compliance Services in Ahmedabad | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Ahmedabad. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-ahmedabad",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-ahmedabad-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Ahmedabad",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Ahmedabad | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-ahmedabad-twitter.jpg"],
  },
};

const GstComplianceAhmedabad = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceAhmedabad} />
...
export default GstComplianceAhmedabad;
