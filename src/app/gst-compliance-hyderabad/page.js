...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceHyderabad, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Hyderabad | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Hyderabad. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Hyderabad, GST audit support, GST notice management, complete GST services, GST compliance management Hyderabad",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-hyderabad",
  },
  openGraph: {
    title: "GST Compliance Services in Hyderabad | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Hyderabad. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-hyderabad",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-hyderabad-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Hyderabad",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Hyderabad | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-hyderabad-twitter.jpg"],
  },
};

const GstComplianceHyderabad = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceHyderabad} />
...
export default GstComplianceHyderabad;
