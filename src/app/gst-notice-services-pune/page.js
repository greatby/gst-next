...
export const metadata = {
  title:
    "GST Notice Reply Services in Pune | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-pune",
  },
};

const GstNoticeServicesPune = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Pune | Expert GST notice handling. Strong
          legal replies. Penalty reduction.
        </title>
        ...
        <meta
          name="keywords"
          content="GST notice services Pune, GST notice reply Pune, GST audit notice reply, DRC-01 reply Pune, GST legal reply Pune, GST show cause notice reply Pune"
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-pune"
        />

        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Pune | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Pune. Expert handling of DRC-01, DRC-02, SCN, audit notices and more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-pune"
        />
        <meta property="og:type" content="website" />

        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-pune-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Pune | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment, and representation. Reduce penalties with strong legal responses in Pune."
        />
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-pune-twitter.jpg"
        />
      ...
      {/* Pune Hero Section */}
      <CompanySection data={heroDataNoticeServicesPune} />

      {/* DO NOT CHANGE ANYTHING BELOW — As per your instruction */}
...
export default GstNoticeServicesPune;
