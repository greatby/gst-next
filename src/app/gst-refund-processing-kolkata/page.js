...
import {
  ...
  heroDataRefundProcessingKolkata,
} from "@/utils/data";
...
export const metadata = {
  title:
    "GST Refund Processing Services in Kolkata | Fast ITC & Export Refunds",
  description:
    "Fast GST refund processing in Kolkata. Export refunds in 30–45 days. ITC refunds handled with expert documentation for maximum refund recovery.",
  alternates: {
    canonical: "https://www.unigst.com/gst-refund-processing-kolkata",
  },
};

const GstRefundProcessingKolkata = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        ...
        <meta
          name="description"
          content="Fast GST refund processing in Kolkata. Export refunds processed in 30–45 days. Expert ITC refund claims with maximum recovery and error-free documentation."
        />

        <meta
          name="keywords"
          content="GST refund Kolkata, GST refund processing, ITC refund Kolkata, export refund Kolkata, GST RFD-01 filing, GST consultant Kolkata"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-refund-processing-kolkata"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Refund Processing Services in Kolkata | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-refund-processing-kolkata"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-refund-processing-kolkata-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Refund Processing in Kolkata | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-refund-processing-kolkata-twitter.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Fast GST refund claims for exporters and ITC applicants in Kolkata. Expert filing with maximum refund recovery.",
      ...
      {/* Hero + Sections */}
      <CompanySection data={heroDataRefundProcessingKolkata} />
...
export default GstRefundProcessingKolkata;
