...
export const metadata = {
  title: "GST Registration Services in Gurgaon | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Gurgaon in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Gurgaon, new GST registration, online GST registration, GST number Gurgaon, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-gurgaon",
  },
};

const GstRegistrationGurgaon = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Gurgaon",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Gurgaon?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Registration Gurgaon", item: "https://www.unigst.com/gst-registration-gurgaon" },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationGurgaon} />
...
export default GstRegistrationGurgaon;
