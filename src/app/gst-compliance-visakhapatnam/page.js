...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceVisakhapatnam, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Visakhapatnam | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Visakhapatnam. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Visakhapatnam, GST audit support, GST notice management, complete GST services, GST compliance management Visakhapatnam",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-visakhapatnam",
  },
  openGraph: {
    title: "GST Compliance Services in Visakhapatnam | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Visakhapatnam. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-visakhapatnam",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-visakhapatnam-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Visakhapatnam",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Visakhapatnam | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-visakhapatnam-twitter.jpg"],
  },
};

const GstComplianceVisakhapatnam = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceVisakhapatnam} />
...
export default GstComplianceVisakhapatnam;
