...
import {
  ...
  aboutSectionDataNoticeServicesMumbai,
  faqsNoticeBangalore,
  faqsNoticeMumbai,
  heroDataNoticeServicesMumbai,
  processStepsNoticeservicesBangalore,
  processStepsNoticeServicesMumbai,
} from "@/utils/data";
...
export const metadata = {
  title:
    "GST Notice Reply Services in Mumbai | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-mumbai",
  },
};

const GstNoticeServicesMumbai = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Mumbai | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Mumbai, GST notice reply Mumbai, GST audit notice reply, DRC-01 notice reply Mumbai, GST legal reply Mumbai, GST show cause notice reply Mumbai"
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-mumbai"
        />

        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Mumbai | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Mumbai. Expert handling of DRC-01, DRC-02, SCN, audit notices and more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-mumbai"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-mumbai-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Mumbai | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-mumbai-twitter.jpg"
        />
      ...
      <CompanySection data={heroDataNoticeServicesMumbai} />
...
export default GstNoticeServicesMumbai;
