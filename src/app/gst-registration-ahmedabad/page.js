...
export const metadata = {
  title: "GST Registration Services in Ahmedabad | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Ahmedabad in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Ahmedabad, new GST registration, online GST registration, GST number Ahmedabad, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-ahmedabad",
  },
};

const GstRegistrationAhmedabad = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Ahmedabad",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Ahmedabad?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "GST Registration Ahmedabad",
        item: "https://www.unigst.com/gst-registration-ahmedabad",
      },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationAhmedabad} />
...
export default GstRegistrationAhmedabad;
