...
export const metadata = {
  title:
    "GST Notice Reply Services in Kolkata | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-kolkata",
  },
};

const GstNoticeServicesKolkata = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Kolkata | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Kolkata, GST notice reply Kolkata, GST audit notice reply, DRC-01 reply Kolkata, GST legal reply Kolkata, GST show cause notice reply Kolkata"
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-kolkata"
        />

        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Kolkata | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Kolkata. Expert handling of DRC-01, DRC-02, SCN, audit notices and more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-kolkata"
        />
        <meta property="og:type" content="website" />

        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-kolkata-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Kolkata | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment, and representation. Reduce penalties with strong legal responses in Kolkata."
        />
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-kolkata-twitter.jpg"
        />
      ...
      {/* Kolkata Hero Section */}
      <CompanySection data={heroDataNoticeServicesKolkata} />
...
export default GstNoticeServicesKolkata;
