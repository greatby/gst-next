...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataCompliancePune, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Pune | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Pune. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Pune, GST audit support, GST notice management, complete GST services, GST compliance management Pune",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-pune",
  },
  openGraph: {
    title: "GST Compliance Services in Pune | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Pune. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-pune",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-pune-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Pune",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Pune | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-pune-twitter.jpg"],
  },
};

const GstCompliancePune = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataCompliancePune} />
...
export default GstCompliancePune;
