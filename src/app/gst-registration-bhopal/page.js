...
export const metadata = {
  title: "GST Registration Services in Bhopal | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Bhopal in just 3-5 days. Expert assistance, 100% online process, all business types. Register for GST quickly and hassle-free!",
  keywords:
    "GST registration Bhopal, new GST registration, online GST registration, GST number Bhopal, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-bhopal",
  },
};

const GstRegistrationBhopal = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Bhopal",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Bhopal?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "GST Registration Bhopal",
        item: "https://www.unigst.com/gst-registration-bhopal",
      },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationBhopal} />
...
export default GstRegistrationBhopal;
