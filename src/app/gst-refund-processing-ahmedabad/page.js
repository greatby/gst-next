...
import {
  ...
  heroDataRefundProcessingAhmedabad,
} from "@/utils/data";
...
export const metadata = {
  title:
    "GST Refund Processing Services in Ahmedabad | Fast ITC & Export Refunds",
  description:
    "Fast GST refund processing in Ahmedabad. Export refunds in 30–45 days. ITC refunds handled with expert documentation for maximum refund recovery.",
  alternates: {
    canonical: "https://www.unigst.com/gst-refund-processing-ahmedabad",
  },
};

const GstRefundProcessingAhmedabad = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        ...
        <meta
          name="description"
          content="Fast GST refund processing in Ahmedabad. Export refunds processed in 30–45 days. Expert ITC refund claims with maximum recovery and error-free documentation."
        />

        <meta
          name="keywords"
          content="GST refund Ahmedabad, GST refund processing, ITC refund Ahmedabad, export refund Ahmedabad, GST RFD-01 filing, GST consultant Ahmedabad"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-refund-processing-ahmedabad"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Refund Processing Services in Ahmedabad | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-refund-processing-ahmedabad"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-refund-processing-ahmedabad-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Refund Processing in Ahmedabad | Fast ITC & Export Refunds"
        />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-refund-processing-ahmedabad-twitter.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Fast GST refund claims for exporters and ITC applicants in Ahmedabad. Expert filing with maximum refund recovery.",
      ...
      {/* Hero + Sections */}
      <CompanySection data={heroDataRefundProcessingAhmedabad} />
...
export default GstRefundProcessingAhmedabad;
