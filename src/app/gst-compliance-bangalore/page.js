...
import { aboutSectionData, aboutSectionDataComplianceBangalore, faqsCompliance, heroData, heroDataComplianceBangalore, processSteps, processStepsComplianceBangalore } from "@/utils/data";
...
export const metadata = {
  title: "GST Compliance Services in Bangalore | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Bangalore. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Bangalore, GST audit support, GST notice management, complete GST services, GST compliance management Bangalore",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-bangalore",
  },
  openGraph: {
    title: "GST Compliance Services in Bangalore | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Bangalore. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-bangalore",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-bangalore-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Bangalore",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Bangalore | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-bangalore-twitter.jpg"],
  },
};
...
const GstComplianceBangalore = () => {
  return (
    ...
    <Script
      ...
      />
      <CompanySection data={heroDataComplianceBangalore} />
