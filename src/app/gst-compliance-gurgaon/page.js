...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceGurgaon, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Gurgaon | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Gurgaon. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Gurgaon, GST audit support, GST notice management, complete GST services, GST compliance management Gurgaon",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-gurgaon",
  },
  openGraph: {
    title: "GST Compliance Services in Gurgaon | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Gurgaon. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-gurgaon",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-gurgaon-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Gurgaon",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Gurgaon | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-gurgaon-twitter.jpg"],
  },
};

const GstComplianceGurgaon = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceGurgaon} />
...
export default GstComplianceGurgaon;
