...
export const metadata = {
  title: "GST Registration Services in Hyderabad | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Hyderabad in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Hyderabad, new GST registration, online GST registration, GST number Hyderabad, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-hyderabad",
  },
};

const GstRegistrationHyderabad = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Hyderabad",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Hyderabad?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Registration Hyderabad", item: "https://www.unigst.com/gst-registration-hyderabad" },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationHyderabad} />
...
export default GstRegistrationHyderabad;
