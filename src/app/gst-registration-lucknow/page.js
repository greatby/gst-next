...
export const metadata = {
  title: "GST Registration Services in Lucknow | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Lucknow in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Lucknow, new GST registration, online GST registration, GST number Lucknow, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-lucknow",
  },
};

const GstRegistrationLucknow = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Lucknow",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Lucknow?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Registration Lucknow", item: "https://www.unigst.com/gst-registration-lucknow" },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationLucknow} />
...
export default GstRegistrationLucknow;
