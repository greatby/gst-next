...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceBhopal, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Bhopal | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Bhopal. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Bhopal, GST audit support, GST notice management, complete GST services, GST compliance management Bhopal",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-bhopal",
  },
  openGraph: {
    title: "GST Compliance Services in Bhopal | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Bhopal. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-bhopal",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-bhopal-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Bhopal",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Bhopal | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-bhopal-twitter.jpg"],
  },
};

const GstComplianceBhopal = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceBhopal} />
...
export default GstComplianceBhopal;
