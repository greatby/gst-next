...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceNagpur, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Nagpur | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Nagpur. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Nagpur, GST audit support, GST notice management, complete GST services, GST compliance management Nagpur",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-nagpur",
  },
  openGraph: {
    title: "GST Compliance Services in Nagpur | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Nagpur. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-nagpur",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-nagpur-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Nagpur",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Nagpur | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-nagpur-twitter.jpg"],
  },
};

const GstComplianceNagpur = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceNagpur} />
...
export default GstComplianceNagpur;
