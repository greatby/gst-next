...
export const metadata = {
  title:
    "GST Notice Reply Services in Nagpur | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-nagpur",
  },
};

const GstNoticeServicesNagpur = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Nagpur | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Nagpur, GST notice reply Nagpur, GST audit notice reply Nagpur, DRC-01 notice reply Nagpur, GST legal reply Nagpur, GST show cause notice reply Nagpur"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-nagpur"
        />

        {/* OG Tags */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Nagpur | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Nagpur. Expert handling of DRC-01, DRC-02, SCN, audit notices & more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-nagpur"
        />
        <meta property="og:type" content="website" />

        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-nagpur-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Nagpur | Fast & Accurate Legal Reply - UNIgst"
        />

        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment, and representation. Reduce penalties with strong legal responses in Nagpur."
        />

        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-nagpur-twitter.jpg"
        />
      ...
      {/* HERO */}
      <CompanySection data={heroDataNoticeServicesNagpur} />
...
export default GstNoticeServicesNagpur;
