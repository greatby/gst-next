...
import {
  ...
  heroDataNoticeServicesCoimbatore,
} from "@/utils/data";
...
export const metadata = {
  title:
    "GST Notice Reply Services in Coimbatore | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-coimbatore",
  },
};

const GstNoticeServicesCoimbatore = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Coimbatore | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Coimbatore, GST notice reply Coimbatore, GST audit notice reply Coimbatore, DRC-01 reply Coimbatore, GST legal reply Coimbatore, GST show cause notice reply Coimbatore"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-coimbatore"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Coimbatore | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Coimbatore. Expert handling of DRC-01, DRC-02, SCN, audit notices & more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-coimbatore"
        />
        <meta property="og:type" content="website" />

        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-coimbatore-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Coimbatore | Fast & Accurate Legal Reply - UNIgst"
        />

        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment, and representation. Reduce penalties with strong legal responses in Coimbatore."
        />

        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-coimbatore-twitter.jpg"
        />
      ...
      {/* HERO */}
      <CompanySection data={heroDataNoticeServicesCoimbatore} />
...
export default GstNoticeServicesCoimbatore;
