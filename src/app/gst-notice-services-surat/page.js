...
export const metadata = {
  title:
    "GST Notice Reply Services in Surat | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-surat",
  },
};

const GstNoticeServicesSurat = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Surat | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Surat, GST notice reply Surat, GST audit notice reply, DRC-01 reply Surat, GST legal reply Surat, GST show cause notice reply Surat"
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-surat"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Surat | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Surat. Expert handling of DRC-01, DRC-02, SCN, audit notices and more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-surat"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-surat-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Surat | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment, and representation. Reduce penalties with strong legal responses in Surat."
        />
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-surat-twitter.jpg"
        />
      ...
      {/* Surat Hero */}
      <CompanySection data={heroDataNoticeServicesSurat} />
...
export default GstNoticeServicesSurat;
