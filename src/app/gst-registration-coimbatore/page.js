...
import {
  ...
  heroDataRegistrationCoimbatore,
} from "@/utils/data";
...
export const metadata = {
  title: "GST Registration Services in Coimbatore | Fast 3-5 Days - UNIgst",
  description:
    "Get GST registration in Coimbatore in just 3-5 days. Expert assistance, 100% online process, all business types. Starting a business? Register for GST today!",
  keywords:
    "GST registration Coimbatore, new GST registration, online GST registration, GST number Coimbatore, GSTIN registration services",
  alternates: {
    canonical: "https://www.unigst.com/gst-registration-coimbatore",
  },
};

const GstRegistrationCoimbatore = () => {
  const serviceSchema = {
    ...
    offers: {
      ...
      priceCurrency: "INR",
      description: "Professional GST registration services in Coimbatore",
    },
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How long does GST registration take in Coimbatore?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Registration Coimbatore", item: "https://www.unigst.com/gst-registration-coimbatore" },
    ],
  };
  ...
  return (
    <>
      ...
      <CompanySection data={heroDataRegistrationCoimbatore} />
...
export default GstRegistrationCoimbatore;
