...
import { aboutSectionDataComplianceBangalore, faqsCompliance, heroDataComplianceKanpur, processStepsComplianceBangalore } from "@/utils/data";
import Script from "next/script";
import CompanySection from "@/components/CompanySection";

export const metadata = {
  title: "GST Compliance Services in Kanpur | Complete Peace of Mind - UNIgst",
  description:
    "End-to-end GST compliance services in Kanpur. Registration, returns, audit support, notice management. Stay penalty-free & audit-ready. 100% compliance guaranteed!",
  keywords:
    "GST compliance services Kanpur, GST audit support, GST notice management, complete GST services, GST compliance management Kanpur",
  alternates: {
    canonical: "https://www.unigst.com/gst-compliance-kanpur",
  },
  openGraph: {
    title: "GST Compliance Services in Kanpur | Complete Solutions",
    description:
      "Comprehensive GST compliance management in Kanpur. Stay penalty-free with expert support for all GST requirements.",
    url: "https://www.unigst.com/gst-compliance-kanpur",
    type: "website",
    locale: "en_IN",
    siteName: "UNIgst",
    images: [
      {
        url: "https://www.unigst.com/images/gst-compliance-kanpur-og.jpg",
        width: 1200,
        height: 630,
        alt: "GST Compliance Services Kanpur",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Compliance Services Kanpur | Complete Peace of Mind",
    description:
      "End-to-end GST compliance management. Expert support, audit-ready systems, 100% compliance guarantee.",
    images: ["https://www.unigst.com/images/gst-compliance-kanpur-twitter.jpg"],
  },
};

const GstComplianceKanpur = () => {
  return (
    <>
      <Script
        id="service-schema"
      ...
      <CompanySection data={heroDataComplianceKanpur} />
...
export default GstComplianceKanpur;
