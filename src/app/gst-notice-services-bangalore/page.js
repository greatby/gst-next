...
import {
  ...
  faqsNoticeBangalore,
  heroDataNoticeServicesBangalore,
...
export const metadata = {
  title:
    "GST Notice Reply Services in Bangalore | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-bangalore",
  },
};

const GstNoticeServicesBangalore = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Bangalore | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Bangalore, GST notice reply Bangalore, GST audit notice reply, DRC-01 notice reply, DRC-02 notice reply, GST legal reply, GST show cause notice reply"
        />

        {/* Correct Canonical URL */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-bangalore"
        />

        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Bangalore | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Bangalore. Expert handling of DRC-01, DRC-02, SCN, audit notices and more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-bangalore"
        />
        <meta property="og:type" content="website" />

        {/* If you have the image, replace URL below */}
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-bangalore-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Bangalore | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-bangalore-twitter.jpg"
        />
      ...
      <CompanySection data={heroDataNoticeServicesBangalore} />
...
export default GstNoticeServicesBangalore;
