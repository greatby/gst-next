...
export const metadata = {
  title:
    "GST Notice Reply Services in Noida | Expert GST notice handling. Strong legal replies. Penalty reduction.",
  description:
  ...
  alternates: {
    canonical: "https://www.unigst.com/gst-notice-services-noida",
  },
};

const GstNoticeServicesNoida = () => {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          GST Notice Reply Services in Noida | Expert GST notice handling.
        ...
        <meta
          name="keywords"
          content="GST notice services Noida, GST notice reply Noida, GST audit notice reply Noida, DRC-01 reply Noida, GST legal reply Noida, GST show cause notice reply Noida"
        />

        {/* Canonical */}
        <link
          rel="canonical"
          href="https://www.unigst.com/gst-notice-services-noida"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="GST Notice Reply Services in Noida | Expert Handling & Strong Legal Drafts"
        />
        <meta
          property="og:description"
          content="Professional GST notice reply services in Noida. Expert handling of DRC-01, DRC-02, SCN, audit notices & more. Reduce penalties with strong legal responses."
        />
        <meta
          property="og:url"
          content="https://www.unigst.com/gst-notice-services-noida"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.unigst.com/images/gst-notice-services-noida-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="GST Notice Services in Noida | Fast & Accurate Legal Reply - UNIgst"
        />
        <meta
          name="twitter:description"
          content="Fast, professional GST notice reply drafting, assessment & representation. Reduce penalties with strong legal responses in Noida."
        />
        <meta
          name="twitter:image"
          content="https://www.unigst.com/images/gst-notice-services-noida-twitter.jpg"
        />
      ...
      {/* Hero */}
      <CompanySection data={heroDataNoticeServicesNoida} />
...
export default GstNoticeServicesNoida;
