...
const ProcessSectionRefund = ({ data }) => {
  return (
    <section className="relative flex flex-col items-center max-w-[90rem] mx-auto px-4 sm:-mt-12">
      ...
      <div className="flex flex-col gap-y-6 text-center items-center max-w-4xl mx-auto">
        <h2 className="text-4xl font-bold text-white">Complete GST Refund Processing Services</h2>
      </div>

      {/* Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-3 border-t border-l border-r md:border-r-0 border-orange-500 my-16 w-full">
        {data.map((step, idx) => (
          <div
            key={idx}
...
export default ProcessSectionRefund;
