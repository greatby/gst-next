...
const ProcessSectionRegistration = ({data}) => {
  return (
    <section className="relative flex flex-col items-center max-w-[90rem] mx-auto px-4 sm:-mt-12">
      ...
      {/* Grid */}
      <div className={`grid grid-cols-1 sm:grid-cols-${data.length} md:grid-cols-5 border-t border-l border-r border-orange-500 my-16 w-full`}>
        {data.map((step, idx) => (
          <div
            key={idx}
...
export default ProcessSectionRegistration;
